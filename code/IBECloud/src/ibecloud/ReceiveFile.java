...
public class ReceiveFile extends javax.swing.JFrame {
    ...
    public ReceiveFile() {
        ...
        File i = SelectFile.sf;
        ifn = i.getName();
        jTextField2.setText(ifn);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Text File Name");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/files.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String line = null;
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader(EncryptFile.f1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       String line = null;
        try {
            //BufferedReader bufferedReader = new BufferedReader(new FileReader("Receiver/Im/encrypt.png"));
            BufferedReader bufferedReader = new BufferedReader(new FileReader(EncryptFile.f2));
            while ((line = bufferedReader.readLine()) != null) {
                jTextArea2.append("\n" + line + "\n");
            }
        } catch (Exception e) {
