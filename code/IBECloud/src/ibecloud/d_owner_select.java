 ...
 */
public class d_owner_select extends javax.swing.JFrame {

    /**
     * Creates new form d_owner_select
     */
    public d_owner_select() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("File Upload Process");
        ...
        jButton2.setFont(new java.awt.Font("Baskerville Old Face", 1, 16)); // NOI18N
        jButton2.setForeground(new java.awt.Color(0, 51, 255));
        jButton2.setText("User Request");
        ...
        jSeparator1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(d_owner_select.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
